...
//  }
 ...
 bool GNSSVIODataProvider::hasData() const {
...
//    LOG(INFO) << "SPIN ONCE 1";
   ...
   current_k_++;
//    LOG(INFO) << "Finished VIO processing for frame k = " << current_k_ - 1;
   return true;
 }
 ...
 const InitializationPerformance GNSSVIODataProvider::getInitializationPerformance(
